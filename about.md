...
<section class="section">
  <div class="two-col">
    <div>
      ...
      <ul class="bullet-list">
        <li><strong>Peer review.</strong> Reviewer for <em>iScience</em> (Cell Press).</li>
