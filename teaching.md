...
description: >-
  Student supervision, interdisciplinary training, teaching and public
  engagement by Nicolas Harmand: a doctoral student, Master's placements, and
  the AQV national course on the rheology of cells and tissues.
---

<h1>Supervision &amp; teaching</h1>

<div class="prose">
  <p class="lead">Explaining a measurement to someone who does not share your training is the same work as making it: you find out what you actually understand. I teach physics to biologists, and I build the material from scratch when none exists.</p>
</div>
...
<section class="section">
  <h2 class="section-title">Courses and workshops for researchers</h2>
  <ul class="conf-list">
    <li>
